...
|---|---|---|---|---|
| 0 | [characterization tests](./phase-0-characterization-tests.md) | 🟡 **In progress** — 11/15 groups, 67 cases passing | `refactor/mailops-phase-0-tests` | 2–3 days |
...
upgrade/remaining-majors
  └─ refactor/mailops                            ← base; plan docs live here
       └─ refactor/mailops-phase-0-tests         ← CURRENT (11/15 groups done)
...
**Totals:** 11/15 files · **67/~85 cases** · 67 passing · 0 failing · tsc clean · lint clean (warnings only)
