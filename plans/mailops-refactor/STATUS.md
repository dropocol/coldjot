...
|---|---|---|---|---|
| 0 | [characterization tests](./phase-0-characterization-tests.md) | 🟡 **In progress** — 12/15 groups, 71 cases passing | `refactor/mailops-phase-0-tests` | 2–3 days |
...
upgrade/remaining-majors
  └─ refactor/mailops                            ← base; plan docs live here
       └─ refactor/mailops-phase-0-tests         ← CURRENT (12/15 groups done)
...
**Totals:** 12/15 files · **71/~85 cases** · 71 passing · 0 failing · tsc clean · lint clean (warnings only)
