...
|---|---|---|---|---|
| 0 | [characterization tests](./phase-0-characterization-tests.md) | 🟡 **In progress** — 8/15 groups, 57 cases passing | `refactor/mailops-phase-0-tests` | 2–3 days |
...
upgrade/remaining-majors
  └─ refactor/mailops                            ← base; plan docs live here
       └─ refactor/mailops-phase-0-tests         ← CURRENT (8/15 groups done)
...
**Totals:** 8/15 files · **57/~85 cases** · 57 passing · 0 failing · tsc clean · lint clean (warnings only)
