...
|---|---|---|---|---|
| 0 | [characterization tests](./phase-0-characterization-tests.md) | 🟡 **In progress** — 7/15 groups, 53 cases passing | `refactor/mailops-phase-0-tests` | 2–3 days |
...
upgrade/remaining-majors
  └─ refactor/mailops                            ← base; plan docs live here
       └─ refactor/mailops-phase-0-tests         ← CURRENT (7/15 groups done)
...
**Totals:** 7/15 files · **53/~85 cases** · 53 passing · 0 failing · tsc clean · lint clean (warnings only)
